...
public class AccountController {
    ...
    @GetMapping("/{id}")
    public CreateAccountResponse getAccountDetails(@PathVariable Integer id) {
        return accountService.getAccountDetails(id);
    }

    @PostMapping("/{id}/deposit")
    public Account depositMoney(@PathVariable Integer id, @RequestBody MoneyRequest request) {
        return accountService.deposit(id, request);
    }

    @PostMapping("/{id}/withdraw")
    public Account withdrawMoney(@PathVariable Integer id, @RequestBody MoneyRequest request) {
        return accountService.withdraw(id, request);
    }

    @GetMapping("/{id}/transactions")
    public List<TransactionResponse> transactionHistory(@PathVariable Integer id) {
